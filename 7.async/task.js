...
removeClock(id) {
    a = this.alarmCollection.length;
    this.alarmCollection = this.alarmCollection.filter(clock => clock.id !== id);
    b = this.alarmCollection.length;
    return a > b;          
}
...
function testCase() {
    ...
    phoneAlarm.addClock('08:01', () => {console.log('Пора вставать'); phoneAlarm.removeClock(2)},2);
    phoneAlarm.addClock('08:02', () => console.log('Подъём'), 3);
